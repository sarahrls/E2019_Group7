...
public class RoomCC102F extends Fragment {
    ...
    public RoomCC102F(@NonNull SessionManagement sess, Context ctx) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        fragmentContents.putInt("Feed", R.layout.activity_room_cc102_f);
    ...
    private void goToFeed(View view) {
        ...
        String getPostURL = "https://knowtech-study.000webhostapp.com/CC102/getPostCC102.php";
